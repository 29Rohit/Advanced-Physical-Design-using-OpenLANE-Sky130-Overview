...
`
Desktop/work/tools/openlane_working_dir/openlane/vsdstdcelldesign/ cp sky130_vsdinv.lef ~/Desktop/work/tools/openlane_working_dir/openlane/designs/picorv32a/src/ //Modifiacation 1
...
set::env(EXTRA LEFS) [glob $::env(OPENLANE_ROOT)/designs/$::env(DESIGN_NAME)/src/*.lef]
vim config.tcl
set ::env(SYNTH_BUFFERING) 1
set ::env(SYNTH_STRATEGY) "AREA 1"
set ::env(SYNTH_STRATEGY) "DELAY 0"
set ::env(SYNTH_SIZING) 1
prep -design picorv32a -tag 01-07_11-07 -overwrite
set lefs [glob $::env(DESIGN_DIR)/src/*.lef]               Modification 2
add_lefs -src $lefs                  Modification 2
run_synthesis
place_io
global_placement_or
detailed_placement 
...
```
 /home/rohit//work/tools/openlane_working_dir/openlane/designs/picorv32a/runs$ magic -T $PDK_ROOT/sky130A/libs.tech/magic/sky130A.tech lef read test1/tmp/merged.lef def read 03-07_16-12/results/routing/picorv32a.def &
```
